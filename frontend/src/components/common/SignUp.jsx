      ...
      <>
         ...
         <section  className="gradient-custom">
            <div  className="container">
               <div style={{backgroundColor:'pink'}} className="row d-flex justify-content-center align-items-center h-100">
                  <div style={{backgroundColor:'lightblue'}} className="col-12 col-md-8 col-lg-6 col-xl-5">
                     <div style={{backgroundColor:'pink', color:'black'}}className="card bg-dark text-white">
                        <div style={{backgroundColor:'lightblue', color:'black'}} className="card-body p-5 text-center">
                           <div className="mb-md-5 mt-md-4 pb-5">
                              <h2 className="fw-bold mb-4 ">SignUp For Registering the Complaint</h2>
                              <p className="fw-bold text-dark-50 mb-4">Please enter your Details</p>
                              <form style={{
  width: '50%',
  margin: '40px auto',
  padding: '20px',
...
onSubmit={handleSubmit}>
                                 ...
                                 <div className="form-outline form-white  fw-bold mb-2">
                                    <Dropdown>
                                 ...
                                 <button className="btn btn-outline-dark btn-lg px-5  fw-bold mt-13" type="submit">Register</button>
                              </form>
                           </div>
                           <div>
                              <p className="fw-bold mb-0">Had an account?<Link to={"/Login"}>Login</Link></p>
                           </div>
                        </div>
                     </div>
                  </div>
