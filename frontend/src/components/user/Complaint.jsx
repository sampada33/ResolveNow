   ...
   return (
      <>
         <div className="text-dark complaint-box ">
            <form onSubmit={handleSubmit} className="compliant-form row register ">
               ...
               <label className=" p-3form-label text-dark fw-bold" htmlFor="comment">Description</label>
               <div className="form-floating">
                  <textarea name="comment" onChange={handleChange} value={userComplaint.comment} className="form-control" required></textarea>
               </div>
               <div className="text-center p-1 col-12 fw-bold">
                  <button type="submit" onClick={handleSubmit} className="mt-2 btn btn-success fw-bold">Register</button>
               </div>
            </form>
         </div>
      </>
